...
class Calendar {  
    ...
    */
    private function _createNavi(){
        ...
        return
            '<div class="header">'.
                '<a class="prev" href="http://localhost/SIM/index.php?operacao=showCalendar&month='.sprintf('%02d',$preMonth).'&year='.$preYear.'">Prev</a>'.
                    '<span class="title">'.date('Y M',strtotime($this->currentYear.'-'.$this->currentMonth.'-1')).'</span>'.
                '<a class="next" href="http://localhost/SIM/index.php?operacao=showCalendar&month='.sprintf("%02d", $nextMonth).'&year='.$nextYear.'">Next</a>'.
            '</div>';
    }
